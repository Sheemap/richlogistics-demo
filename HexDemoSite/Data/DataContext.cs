    ...
    public static void MigrateAndSeed(DataContext context)
    {
        ...
        if (!context.DepartmentPositions.Any())
        {
            context.DepartmentPositions.AddRange(
                new DepartmentPosition { Id = 1, EmployeeId = 1, RoleId = 1, Department = "Operations", Location = "LITTLE ROCK", JobDescription = "Handle HR duties within the department" },
                new DepartmentPosition { Id = 2, EmployeeId = 2, RoleId = 2, Department = "Operations", Location = "LAREDO", JobDescription = "Manage employees within the operations department" },
                new DepartmentPosition { Id = 3, RoleId = 3, Department = "Operations", Location = "LITTLE ROCK", JobDescription = "Ensure the workspace is kept to a certain cleanliness level" }
            );
        }
